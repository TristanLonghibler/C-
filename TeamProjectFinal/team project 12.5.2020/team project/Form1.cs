    ...
    public partial class Form1 : Form
    {
        ...
        private void updatefood_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < myUsersBSList.Count; i++)
            {
                if (myUsersBSList[i].userName == userName)
                {
                    myUsersBSList[i].foodEaten.RemoveAll(x => x.foodEntry == foodEntry);
        ...
        private void tabPage3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < myUsersBSList.Count; i++)
            {
                if (myUsersBSList[i].userName == userName)
                {
                    listBoxMonday.DataSource = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item).ToList<FoodEntry>();
                    listBoxTuesday.DataSource = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Tuesday).Select(item => item).ToList<FoodEntry>();
                    listBoxMonday.DataSource = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item).ToList<FoodEntry>();
                    listBoxMonday.DataSource = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item).ToList<FoodEntry>();
                    listBoxMonday.DataSource = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item).ToList<FoodEntry>();
                    listBoxMonday.DataSource = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item).ToList<FoodEntry>();
                    ...
                    double MondaySum = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item.getTotalCalCount()).Sum();
                    //double MondaySum = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item.calCount).Sum();
                    //double MondaySum = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item.calCount).Sum();
                    //double MondaySum = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item.calCount).Sum();
                    //double MondaySum = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item.calCount).Sum();
                    //double MondaySum = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item.calCount).Sum();
                    ...
                    MessageBox.Show(MondaySum.ToString());
                }
            }
        }
        ...
        private void tabControl1_TabIndexChanged(object sender, EventArgs e)
        {
            ...
            if (tabControl1.SelectedTab == tabControl1.TabPages["Weekly Summary"])
            {
                String userName = comboBoxUser.Text;
                ...
                for (int i = 0; i < myUsersBSList.Count; i++)
                {
                    if (myUsersBSList[i].userName == userName)
                    {
                        MessageBox.Show(myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item.foodEntry).ToString());
                        listBoxMonday.DataSource = myUsersBSList[i].foodEaten.Where(item => item.eatingTime.DayOfWeek == DayOfWeek.Monday).Select(item => item.foodEntry);
                    }
                }
